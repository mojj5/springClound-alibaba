if(!("ace" in window)){window.ace={}}ace.config={cookie_expiry:604800,storage_method:2};


ace.settings={is:function(b,a){return(ace.data.get("settings",b+"-"+a)==1)},
...
ace.settings.check=function(c,e){
    ...
    if(!ace.settings.exists(c,e)){return}
    ...
    if(a!=ace.hasClass(d,b[c+"-"+e])){ace.settings[c.replace("-","_")+"_"+e](a)}
